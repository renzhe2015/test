...
/**
 * A copy of {@link android.widget.TextClock}
 * that replace {@link System#currentTimeMillis()} with {@link TvManager#getDtvTimeMillis()}.
 * @author shangchieh@realtek.com
 *
 */
@RemoteView
public class DtvTextClock extends TextView {
    /**
    ...
    public DtvTextClock(Context context) {
        super(context);
        init();
    }
     ...
     */
    @SuppressWarnings("UnusedDeclaration")
    public DtvTextClock(Context context, AttributeSet attrs) {
     ...
     */
    public DtvTextClock(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init() {
        mTvManager = (TvManager) getContext().getSystemService(Context.TV_SERVICE);
