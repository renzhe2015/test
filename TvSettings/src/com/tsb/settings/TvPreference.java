...
//    private static final String TAG = "TvPreference";
	...
	synchronized public void SetNoSignalPower(int sourceId,boolean enable)
	{
		if(mSharedPreferences == null)	return;
		SharedPreferences.Editor et = mSharedPreferences.edit();
		final String key = "noSignal_"+sourceId;
		et.putBoolean(key,enable);
		et.commit();
		et = null;
	}

	public boolean GetNoSignalPower(int sourceId)
	{
